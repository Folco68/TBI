...
#ifndef EVENTOPENINDEX_HPP
#define EVENTOPENINDEX_HPP

#include <QEvent>

class EventOpenIndex : public QEvent
{
  public:
    EventOpenIndex(bool ForceIndexCheck);
    bool forceIndexCheck() const;

  private:
    bool ForceIndexCheck;
};

#endif // EVENTOPENINDEX_HPP
