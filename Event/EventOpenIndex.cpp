...
#include "EventOpenIndex.hpp"
#include "Global.hpp"

EventOpenIndex::EventOpenIndex(bool ForceIndexCheck)
    : QEvent(EVENT_OPEN_INDEX)
    , ForceIndexCheck(ForceIndexCheck)
{}

bool EventOpenIndex::forceIndexCheck() const
{
    return this->ForceIndexCheck;
}
